package net.chrqnos.more_vault.effect;

import net.chrqnos.more_vault.MoreVault;
...
public class CustomEffects {
    ...
    public static RegistryEntry.Reference<StatusEffect> registerEffect(String id, StatusEffect statusEffect) {
        return Registry.registerReference(Registries.STATUS_EFFECT, Identifier.of(MoreVault.MOD_ID, id), statusEffect);
    }
